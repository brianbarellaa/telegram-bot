...
CREATE TABLE `Assurance`.`"Monitor" + Date.now` (`No.` INT NOT NULL AUTO_INCREMENT, `Tiket` TEXT(45), `Layanan` TEXT(45), `Progress` TEXT(45), `Pelanggan` TEXT(45), `Teknisi` TEXT(45));
